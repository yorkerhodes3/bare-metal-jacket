...
const requiredPaths = [
  ...
  "docs/operations/add-gpu-worker.md",
  ...
  "deploy/gpu-worker/docker-compose.yml",
  "deploy/gpu-worker/README.md",
  "deploy/gpu-worker/node.example.json",
  "deploy/gpu-worker/status/Dockerfile",
  "deploy/gpu-worker/status/server.mjs",
  "deploy/gpu-worker/systemd/bare-metal-jacket-gpu-worker.service",
  "deploy/gpu-worker/wait-for-private-address.sh",
  ...
  "scripts/gpu-worker-preflight.sh",
  "scripts/gpu-worker-smoke.mjs",
  "scripts/install-gpu-worker.sh",
  ...
  ".github/skills/add-gpu-worker/SKILL.md",
